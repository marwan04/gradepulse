...
class InstructorSectionController extends Controller
{
     ...
     * - Retrieves only sections belonging to the logged-in instructor.
     */
     ...
     * - Retrieves available courses and predefined semesters.
     */
     ...
     * - Validates input and ensures the instructor is automatically assigned.
     */
    public function store(Request $request)
    {
        $request->validate([
            ...
            'CourseID'  => 'required|integer|exists:Course,CourseID', // Ensure Course exists
        ]);
     ...
     * - Ensures that the instructor can only edit their own sections.
     */
     ...
     * - Ensures validation and instructor ownership before updating.
     */
